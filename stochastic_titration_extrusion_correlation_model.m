...
Abox = max(Nd*datAn + sum(DNAcopy(1:round(0.8*Cperiod/dt)))/numel(DNAcopy(1:round(0.8*Cperiod/dt)))*Chns - H,0);
...
%% save data
% saveingname = 'stochastic_titration_extrusion_correlation_model';
% 
...
% 
% clear h h0 h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 h12
% save(saveingname);
% toc;
