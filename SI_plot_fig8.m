close all ;
clear all ;
% try datA = 100 200 300;
% try Abox_range = 0.5 0.8 1;
% try noise on growth rate
...
datAn = 300 ; % dnaA binding site on datA
...
% ylabel('Adder slope, k');
% xlabel('growth rate (hr^-^1)');
% legend(['box range = ' num2str(Abox_range)]);
% set(gca,'fontsize',14);
% axis square
